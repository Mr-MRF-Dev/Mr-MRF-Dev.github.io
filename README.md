...
A modern, responsive portfolio website showcasing my skills and projects as a Full Stack Developer. Built with vanilla HTML, CSS, and JavaScript, featuring dynamic GitHub integration and a sleek dark/light theme toggle.
...
- **📄 Dynamic Projects**: Pagination system showing 6 projects at a time
...
2. **About**: Professional background with GitHub stats (Projects, Followers)
3. **Projects**: Dynamically loaded repositories with pagination
